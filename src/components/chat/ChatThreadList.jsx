  ...
  return (
    <section className="flex h-full flex-col rounded-3xl border border-[#e5e4e7] bg-white p-4 shadow-2xl">
      ...
      <button
        type="button"
        onClick={onNewThread}
        className="mt-4 inline-flex items-center justify-center gap-2 rounded-2xl border border-[#9d31ff]/15 bg-[#f8faff] px-4 py-3 text-sm font-semibold text-[#9d31ff] transition hover:border-[#9d31ff]/30 hover:bg-[#fff5fb]"
      >
